    ...
    publishing {
        ...
        publications {
            ...
            withType<MavenPublication>().all {
                ...
                with(pom) {
                    name.set("Simple kotlin collection")
                    description.set("Library with implementation some collections for kotlin multiplatfom projects")
                    url.set("https://github.com/EdmonDantes/simple-kotlin-collections")
                    developers {
                        developer {
                    ...
                    scm {
                        connection.set("scm:git:git://github.com/EdmonDantes/simple-kotlin-collections.git")
                        developerConnection.set("scm:git:ssh://github.com:EdmonDantes/simple-kotlin-collections.git")
                        url.set("https://github.com/EdmonDantes/simple-kotlin-collections/tree/master")
                    }
                }
